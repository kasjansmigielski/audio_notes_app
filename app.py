...
#model OpenAI: text->embeddings
EMBEDDING_MODEL = "text-embedding-3-large"
#wymiarowość wektorów
EMBEDDING_DIM = 3072
#model OpenAI: speech->text
...
#łączenie lokalnie z bazą QDrant
@st.cache_resource
...
#upewnienie czy kolekcja istnieje -> jeśli NIE - stworzenie kolekcji
...
#przeliczenie tekstu na embeddings
...
#dodawanie notatek do bazy QDrant
...
#wyszukiwanie notatek w bazie QDrant
...
with add_tab:
    ...
    if note_audio:
        ...
        if st.session_state["note_audio_bytes_md5"] != current_md5:
            st.session_state["note_audio_text"] = ""
            #wyzerowanie edytowanej notatki
            st.session_state["note_text"] = ""
        ...
        if st.session_state["note_audio_text"]:
            st.session_state["note_text"] = st.text_area("Edytuj notatkę", 
                                            value=st.session_state["note_audio_text"])

        if st.session_state["note_text"] and st.button("Zapisz notatkę", 
